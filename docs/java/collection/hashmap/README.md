...
这个问题我觉得问的一般，但是是之前真实遇到的一个问题，基于我的理解，我能想到的是：
- 因为HashMap底层是数组，所以最好是放入之前先指定好数组的大小，比如一百万的数据就设置为2^20=1048576‬，但是如果这样设置，那默认的扩容因子是0.75，到达2^20*0.75=786432‬时便还有一次扩容，所以直接设置成2^21
